                        ...
                        {{-- <form action="{{route('alljobs')}}" method="GET">
                            <div class="text-center mx-auto">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="position" id="" placeholder="Kata Kunci | Nama Pekerjaan | Posisi" class="text-center form-control">
                            ...
                            <form action="{{route('alljobs')}}" method="GET">
                                ...
                                <div class="card-body justify">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-2"><button class="btn btn-outline-dark text-center form-control">Cari</button></div>
                                    </div>
                                </div>
                            </form>
                        </div>
